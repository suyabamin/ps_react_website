...
export function init() {
  ...
  container.innerHTML = `
    <div class="card-glass anim-slide-up" style="display: flex; flex-direction: column; overflow: hidden; padding: 1.25rem;">
      <!-- Module header -->
      ...
      <div class="chat-workspace-grid">
        ...
        <div class="chat-history-sidebar">
          <button id="chat-new-btn" class="btn-primary" style="font-size: 0.8rem; padding: 0.5rem; width: 100%; border-radius: 8px; font-weight: 700; display:flex; align-items:center; justify-content:center; gap:6px;">
        ...
        <div class="chat-main-pane">
          ...
          <div class="card-glass" style="padding: 0.5rem 0.75rem; background: rgba(0,0,0,0.15); border-radius: 12px; flex-shrink: 0;">
            <div style="display: flex; gap: 10px; align-items: flex-end;">
              <textarea id="chat-prompt-textarea" class="input-glass" style="flex: 1; min-height: 48px; max-height: 120px; resize: none; font-size: 0.92rem; line-height: 1.4; padding: 0.4rem 0.6rem; border: none; background: transparent;" placeholder="Ask AI Assistant anything... (Enter to send, Shift+Enter for newline)"></textarea>
              <button id="chat-prompt-send-btn" class="btn-primary" style="padding: 0.5rem 1rem; border-radius: 8px; height: 38px; display: flex; align-items: center; font-weight: 700;">Send</button>
            </div>
          </div>
        </div>
      </div>
